		...
		<div class="row">
			<div class="col-lg-4 m-auto">
				...
				<form action="update" method="post">
					...
					<label>Firstname</label> <input type="text" name="fname" id="fname" class="form-control" value="<%=st.getFname()%>" onkeyup="validation()">
					<span id="fnameE" class="text-danger"></span>
					</div>
					<div class="form-group">
					<label>Lastname</label> <input type="text" name="lname" id="lname" class="form-control"  value="<%=st.getLname()%>" onkeyup="validation()">
					<span id="lnameE" class="text-danger"></span>
					</div>
					<div class="form-group">
					<label>Email</label> <input type="text" name="email"   value="<%=st.getEmail()%>" id="email" class="form-control" onkeyup="validation()">
					<span id="emailE" class="text-danger"></span>
					</div>
					<div class="form-group">
					<label>Password</label> <input type="text" name="pass" id="pass"  value="<%=st.getPass()%>" class="form-control" onkeyup="validation()">
					...
					<div class="form-group">	
						...
						name="phno" id="phno" class="form-control"  value="<%=st.getPhno()%>" onkeyup="validation()">
